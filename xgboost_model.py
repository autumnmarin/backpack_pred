...
xgb_model = XGBRegressor(
    subsample = 0.7627884249891469, 
    n_estimators= 1100, 
    max_depth= 9, 
    learning_rate= 0.0010225517169364501, 
    colsample_bytree= 0.45880009753975803,
    # learning_rate=0.05,
...
y_pred_val = np.expm1(xgb_model.predict(X_val))
...
print(f"\n✅ XGBoost Train RMSE: {train_rmse:.4f}")
print(f"✅ XGBoost Validation RMSE: {val_rmse:.4f}")

# plt.figure(figsize=(8, 6))
# plt.bar(["Train RMSE", "Validation RMSE"], [train_rmse, val_rmse], color=["#4682B4", "#FF8C00"])
# plt.ylabel("RMSE")
